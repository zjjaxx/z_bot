...
class EventEngine:
    ...
    def __init__(self):
        ...
        # 事件引擎处理线程
        self.__thread = Thread(target=self.__run, name="EventEngine.__thread",daemon=True)
    ...
    def __run(self):
        ...
        while self.__active:
            try:
                ...
                handle_thread = Thread(target=self.__process, name="EventEngine.__process",daemon=True, args=(event,))
                handle_thread.start()
            except Empty:
                pass
